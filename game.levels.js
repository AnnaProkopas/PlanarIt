...
const presetLevels = [
    ...
    },
    {
        points: [{ x: field.width / 2, y: field.height / 8},
                 ...
                 { x: field.width / 3, y: field.height / 3},//CONST!!!
                 { x: 2*field.width / 3, y: field.height / 3},//CONST!!!
                 { x: 2*field.width / 3, y: 2*field.height / 3},//CONST!!!
                 { x: field.width / 3, y: 2*field.height / 3},//CONST!!!
                 { x: field.width / 2, y: field.height / 2}],//CONST!!!
        edges: [[0, 8, 2],
                [3, 8, 1],
                     [4, 5, 6, 7, 4]]
    },
    {
        points: [{ x: field.width / 2, y: field.height / 7},//CONST!!!
                 { x: 6 * field.width / 7, y: field.height / 2},//CONST!!!
                 { x: field.width / 2, y: 6 * field.height / 7},//CONST!!!
                 { x: field.width / 7, y: field.height / 2}, //CONST!!!
                 { x: field.width / 5, y: field.height / 5},//CONST!!!
                 { x: 4 * field.width / 5, y: field.height / 5},//CONST!!!
                 { x: 4 * field.width / 5, y: 4 * field.height / 5},//CONST!!!
                 { x: field.width / 5, y: 4 * field.height / 5},//CONST!!!
    ...
    {
        points: [{ x: field.width / 2, y: field.height / 4},//CONST!!!
                 { x: field.width / 2, y: 3*field.height / 4},//CONST!!!
                 { x: 3 * field.width / 4, y: field.height / 2},//CONST!!!
                 { x: field.width / 4, y: field.height / 2},//CONST!!!
                 { x: field.width / 2, y: field.height / 2},
                 { x: field.width / 3, y: field.height / 3},
                 { x: 2*field.width / 3, y: field.height / 3},//CONST!!!
                 { x: 2*field.width / 3, y: 2*field.height / 3},
